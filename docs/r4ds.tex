...
\begin{Highlighting}[]
\NormalTok{flights }\SpecialCharTok{\%\textgreater{}\%}
    \CommentTok{\# Considerar apenas os registros que tem a informação sobre o avião, hora de chegada e atraso na chegada}
...
\hypertarget{valiauxe7uxe3o}{%
\section{Valiação}\label{valiauxe7uxe3o}}
