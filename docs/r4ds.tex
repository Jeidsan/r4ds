...
\item
  Devo incluir os aspectos matemáticos para mostrar a relação entre as variáveis citadas no \protect\hyperlink{exr19-2-2}{Exercício 19.2.2}?
\item
  Revisar \protect\hyperlink{exr19-2-3}{Exercício 19.2.3};
\item
  Revisar \protect\hyperlink{exr19-3-4}{Exercício 19.3.4};
\item
  \protect\hyperlink{exr19-3-5}{Exercício 19.3.5};
\item
  \protect\hyperlink{exr19-3-6}{Exercício 19.3.6};
\item
  \protect\hyperlink{exr19-3-7}{Exercício 19.3.7};
\item
  \protect\hyperlink{exr19-3-8}{Exercício 19.3.8};
\item
...
\item
  \protect\hyperlink{exr22-2-2}{Exercício 22.2.2};
\item
  \protect\hyperlink{exr22-2-3}{Exercício 22.2.3};
\item
\end{itemize}
...
\begin{verbatim}
## List of 4
##  $ : num [1:10] -9.82 -10.06 -12.12 -11.81 -11.07 ...
##  $ : num [1:10] -0.6659 -0.0913 0.4559 0.8231 -1.4465 ...
##  $ : num [1:10] 10.64 9.39 8.15 10.16 10.14 ...
##  $ : num [1:10] 100.7 99 100.4 99.8 100.1 ...
\end{verbatim}
...
\begin{verbatim}
##   [1]  0.9465743  1.5495124  2.4700419  2.7406080  3.4313253  4.0743286
##   [7]  4.8178170  5.3924114  6.3320392  6.6878085  7.5348192  8.1930433
##  [13]  8.4144702  9.1414547  9.7692519 10.4535963 11.0728527 11.3779059
##  [19] 11.7181031 12.2562467 12.8168579 13.3293044 13.9421392 14.4629342
##  [25] 15.2635128 16.1610348 16.3347116 16.8281350 16.9839226 17.4661546
##  [31] 18.2306666 18.8182408 18.9560289 18.9626794 19.0038814 19.3887142
##  [37] 20.3513463 21.0559380 21.0959176 21.2520878 21.5908668 21.9104135
##  [43] 22.1062846 23.0452767 23.9428274 24.7871435 24.8607800 25.6721471
##  [49] 25.8709577 26.0417020 26.9582490 27.3950728 28.1656051 28.9623611
##  [55] 29.2889834 29.5915934 29.7061535 30.5887601 30.8478487 31.4653000
##  [61] 32.2428607 32.9066629 33.7609059 34.4635674 35.1269455 36.0804550
##  [67] 36.0945110 37.0387947 37.8590191 38.3012748 38.6538216 39.1435539
##  [73] 39.4878324 39.7410914 40.6328138 40.7857594 41.6356333 41.8075878
##  [79] 42.0881499 42.9602272 42.9661924 43.8735715 44.6747800 45.2744626
##  [85] 45.9513279 46.7607724 47.7468632 47.8589869 48.3661212 48.8145081
##  [91] 48.8522828 48.8889326 49.6460435 50.6136927 51.3786747 52.3621559
##  [97] 52.4339908 52.7184779 53.1493939 53.6916188
\end{verbatim}
...
## 1   No allocation          100    0.22    3.143      0.22        0         NA
...
\addcontentsline{toc}{subsection}{Exercício 18.2.1}
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-276-1.pdf}

\end{solution}

\hypertarget{exr18-2-2}{%
\subsection*{Exercício 18.2.2}\label{exr18-2-2}}
\addcontentsline{toc}{subsection}{Exercício 18.2.2}
...
Use \texttt{optim()} para ajustar esse modelo nos dados previamente simulados e compare-o ao modelo linear.
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Definindo a distância baseada no erro quadrático médio}
\NormalTok{erro\_quadratico\_medio }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(mod, data) \{}
\NormalTok{  diff }\OtherTok{\textless{}{-}}\NormalTok{ data}\SpecialCharTok{$}\NormalTok{y }\SpecialCharTok{{-}}\NormalTok{ (mod[}\DecValTok{1}\NormalTok{] }\SpecialCharTok{+}\NormalTok{ data}\SpecialCharTok{$}\NormalTok{x }\SpecialCharTok{*}\NormalTok{ mod[}\DecValTok{2}\NormalTok{])}
  \FunctionTok{sqrt}\NormalTok{(}\FunctionTok{mean}\NormalTok{(diff }\SpecialCharTok{\^{}} \DecValTok{2}\NormalTok{))}
\NormalTok{\}}

\CommentTok{\# Definindo a distância baseada na média da distãncia absoluta}
\NormalTok{distancia\_media\_absoluta }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(mod, data) \{}
\NormalTok{  diff }\OtherTok{\textless{}{-}}\NormalTok{ data}\SpecialCharTok{$}\NormalTok{y }\SpecialCharTok{{-}} \FunctionTok{make\_prediction}\NormalTok{(mod, data)}
  \FunctionTok{mean}\NormalTok{(}\FunctionTok{abs}\NormalTok{(diff))}
\NormalTok{\}}

\CommentTok{\# Definindo a função auxiliar}
\NormalTok{make\_prediction }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(mod, data) \{}
\NormalTok{  mod[}\DecValTok{1}\NormalTok{] }\SpecialCharTok{+}\NormalTok{ mod[}\DecValTok{2}\NormalTok{] }\SpecialCharTok{*}\NormalTok{ data}\SpecialCharTok{$}\NormalTok{x}
\NormalTok{\}}

\CommentTok{\# Gerando o modelo otimizado}
\NormalTok{modelo\_erro\_quadratico\_medio }\OtherTok{\textless{}{-}} \FunctionTok{optim}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{), erro\_quadratico\_medio, }\AttributeTok{data =}\NormalTok{ sim1a)}
\NormalTok{modelo\_distancia\_media\_absoluta }\OtherTok{\textless{}{-}} \FunctionTok{optim}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{), distancia\_media\_absoluta, }\AttributeTok{data =}\NormalTok{ sim1a)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(sim1a, }\FunctionTok{aes}\NormalTok{(x,y)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_abline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{intercept =}\NormalTok{ modelo\_erro\_quadratico\_medio}\SpecialCharTok{$}\NormalTok{par[[}\DecValTok{1}\NormalTok{]], }\AttributeTok{slope =}\NormalTok{ modelo\_erro\_quadratico\_medio}\SpecialCharTok{$}\NormalTok{par[[}\DecValTok{2}\NormalTok{]]), }\AttributeTok{color =} \StringTok{"red"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_abline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{intercept =}\NormalTok{ modelo\_distancia\_media\_absoluta}\SpecialCharTok{$}\NormalTok{par[[}\DecValTok{1}\NormalTok{]], }\AttributeTok{slope =}\NormalTok{ modelo\_distancia\_media\_absoluta}\SpecialCharTok{$}\NormalTok{par[[}\DecValTok{2}\NormalTok{]]), }\AttributeTok{color =} \StringTok{"blue"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{r4ds_files/figure-latex/unnamed-chunk-278-1.pdf}
...
\addcontentsline{toc}{subsection}{Exercício 18.2.3}
...
\addcontentsline{toc}{subsection}{Exercício 18.3.1}
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-281-1.pdf}
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-282-1.pdf}
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-283-1.pdf}
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-284-1.pdf}
...
\addcontentsline{toc}{subsection}{Exercício 18.3.2}
...
\addcontentsline{toc}{subsection}{Exercício 18.3.3}
...
\addcontentsline{toc}{subsection}{Exercício 18.3.4}
...
\addcontentsline{toc}{subsection}{Exercício 18.4.1}
...
\addcontentsline{toc}{subsection}{Exercício 18.4.2}
...
\addcontentsline{toc}{subsection}{Exercício 18.4.3}
...
\addcontentsline{toc}{subsection}{Exercício 18.4.4}
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-292-1.pdf}
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-293-1.pdf}
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-294-1.pdf}
...
\begin{Highlighting}[]
\NormalTok{diamonds2 }\OtherTok{\textless{}{-}}\NormalTok{ diamonds }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(carat }\SpecialCharTok{\textless{}=} \FloatTok{2.5}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}
    \AttributeTok{lprice =} \FunctionTok{log2}\NormalTok{(price),}
    \AttributeTok{lcarat =} \FunctionTok{log2}\NormalTok{(carat)}
\NormalTok{  )}

\NormalTok{mod\_diamond2 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(lprice }\SpecialCharTok{\textasciitilde{}}\NormalTok{ lcarat }\SpecialCharTok{+}\NormalTok{ color }\SpecialCharTok{+}\NormalTok{ cut }\SpecialCharTok{+}\NormalTok{ clarity, }\AttributeTok{data =}\NormalTok{ diamonds2)}

\NormalTok{diamonds2 }\OtherTok{\textless{}{-}} \FunctionTok{add\_residuals}\NormalTok{(diamonds2, mod\_diamond2, }\StringTok{"lresid2"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\hypertarget{exr19-2-1}{%
\subsection*{Exercício 19.2.1}\label{exr19-2-1}}
\addcontentsline{toc}{subsection}{Exercício 19.2.1}

No gráfico \texttt{lcarat} \emph{versus} \texttt{lprice} há algumas listras verticais claras. O que elas representam?

\begin{solution}
Eles representam a concentração de diamantes com valores arredondados para números ``human friendly'', ``bonitos''.
\end{solution}

\hypertarget{exr19-2-2}{%
\subsection*{Exercício 19.2.2}\label{exr19-2-2}}
\addcontentsline{toc}{subsection}{Exercício 19.2.2}

Se \texttt{log(price)\ =\ a\_0\ +\ a\_1\ *\ log(carat)}, o que isso diz sobre o relacionamento entre \texttt{price} e \texttt{carat}?

\begin{solution}
De modo bastante simplificado, se há uma relação linear entre \(log_2(carat)\) e \(log_2(price)\), podemos afirmar que há uma relação exponencial entre \texttt{carat} e \texttt{price}. Isso significa que o aumento de \(x\) unidades em \texttt{carat}, corresponde a um crescimento da ordem de \(2^x\) em \texttt{price}.
\end{solution}

\hypertarget{exr19-2-3}{%
\subsection*{Exercício 19.2.3}\label{exr19-2-3}}
\addcontentsline{toc}{subsection}{Exercício 19.2.3}
...
\hypertarget{exr19-2-4}{%
\subsection*{Exercício 19.2.4}\label{exr19-2-4}}
\addcontentsline{toc}{subsection}{Exercício 19.2.4}

O modelo final, \texttt{mod\_diamonds2}, faz um bom trabalho na previsão dos preços de diamantes? Você confiaria nele para dizer quanto gastar se fosse comprar um diamante?
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(diamonds2, }\FunctionTok{aes}\NormalTok{(lcarat, lresid2)) }\SpecialCharTok{+}
  \FunctionTok{geom\_hex}\NormalTok{(}\AttributeTok{bins =} \DecValTok{50}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_ref\_line}\NormalTok{(}\AttributeTok{h =} \DecValTok{0}\NormalTok{, }\AttributeTok{size =} \FloatTok{0.25}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_ref\_line}\NormalTok{(}\AttributeTok{h =} \FloatTok{0.75}\NormalTok{, }\AttributeTok{size =} \FloatTok{0.25}\NormalTok{, }\AttributeTok{colour =} \StringTok{"red"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_ref\_line}\NormalTok{(}\AttributeTok{h =} \SpecialCharTok{{-}}\FloatTok{0.75}\NormalTok{, }\AttributeTok{size =} \FloatTok{0.25}\NormalTok{, }\AttributeTok{colour =} \StringTok{"red"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{r4ds_files/figure-latex/unnamed-chunk-297-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{diamonds2 }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{summarise}\NormalTok{(}
    \AttributeTok{sd =} \FunctionTok{sd}\NormalTok{(lresid2),}
    \AttributeTok{rmse =} \FunctionTok{sqrt}\NormalTok{(}\FunctionTok{mean}\NormalTok{(lresid2}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)),}
    \AttributeTok{mae =} \FunctionTok{mean}\NormalTok{(}\FunctionTok{abs}\NormalTok{(lresid2)),}
    \AttributeTok{p025 =} \FunctionTok{quantile}\NormalTok{(}\DecValTok{2}\SpecialCharTok{\^{}}\NormalTok{lresid2, }\FloatTok{0.025}\NormalTok{),}
    \AttributeTok{p975 =} \FunctionTok{quantile}\NormalTok{(}\DecValTok{2}\SpecialCharTok{\^{}}\NormalTok{lresid2, }\FloatTok{0.975}\NormalTok{)}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}
...
Avaliando os dados, vemos que o erro quadrático médio é de aproximadamente \texttt{0.19} o que corresponderia a um erro em torno de 14\%. Se usarmos o erro médio (em torno de \texttt{0.15}), teríamos um erro na casa de 11\%. Ademais, temos que 95\% das previsões erram entre 23\% e 31\%.
...
\NormalTok{daily }\OtherTok{\textless{}{-}}\NormalTok{ daily }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{wday =} \FunctionTok{wday}\NormalTok{(date, }\AttributeTok{label =} \ConstantTok{TRUE}\NormalTok{))}

\NormalTok{term }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(date) \{}
  \FunctionTok{cut}\NormalTok{(date,}
    \AttributeTok{breaks =} \FunctionTok{ymd}\NormalTok{(}\DecValTok{20130101}\NormalTok{, }\DecValTok{20130605}\NormalTok{, }\DecValTok{20130825}\NormalTok{, }\DecValTok{20140101}\NormalTok{),}
    \AttributeTok{labels =} \FunctionTok{c}\NormalTok{(}\StringTok{"spring"}\NormalTok{, }\StringTok{"summer"}\NormalTok{, }\StringTok{"fall"}\NormalTok{)}
\NormalTok{  )}
\NormalTok{\}}

\NormalTok{daily }\OtherTok{\textless{}{-}}\NormalTok{ daily }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{term =} \FunctionTok{term}\NormalTok{(date))}

\NormalTok{mod }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(n }\SpecialCharTok{\textasciitilde{}}\NormalTok{ wday, }\AttributeTok{data =}\NormalTok{ daily)}

\NormalTok{daily }\OtherTok{\textless{}{-}}\NormalTok{ daily }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{add\_residuals}\NormalTok{(mod)}

\NormalTok{mod1 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(n }\SpecialCharTok{\textasciitilde{}}\NormalTok{ wday, }\AttributeTok{data =}\NormalTok{ daily)}
\NormalTok{mod2 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(n }\SpecialCharTok{\textasciitilde{}}\NormalTok{ wday }\SpecialCharTok{*}\NormalTok{ term, }\AttributeTok{data =}\NormalTok{ daily)}
\end{Highlighting}
\end{Shaded}

\hypertarget{exr19-3-1}{%
\subsection*{Exercício 19.3.1}\label{exr19-3-1}}
\addcontentsline{toc}{subsection}{Exercício 19.3.1}
...
\hypertarget{exr19-3-2}{%
\subsection*{Exercício 19.3.2}\label{exr19-3-2}}
\addcontentsline{toc}{subsection}{Exercício 19.3.2}
...
\NormalTok{daily }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{top\_n}\NormalTok{(}\DecValTok{3}\NormalTok{, resid)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{exr19-3-3}{%
\subsection*{Exercício 19.3.3}\label{exr19-3-3}}
\addcontentsline{toc}{subsection}{Exercício 19.3.3}

Crie uma nova variável que separe a variável \texttt{wday} em períodos, mas somente para os sábados. Por exemplo, ela deve ter \texttt{Thurs}, \texttt{Fri}, menos \texttt{Sat-summer}, \texttt{Sat-spring}, \texttt{Sat-fall}. Como esse modelo se compara com o modelo com cada combinação de \texttt{wday} e \texttt{term}?

\begin{solution}
Iniciaremos usando a função \texttt{case\_when()} para criar a nova variável.
...
\NormalTok{        wday }\SpecialCharTok{==} \StringTok{"sáb"} \SpecialCharTok{\&}\NormalTok{ term }\SpecialCharTok{==} \StringTok{"summer"} \SpecialCharTok{\textasciitilde{}} \StringTok{"sáb\_summer"}\NormalTok{,}
\NormalTok{        wday }\SpecialCharTok{==} \StringTok{"sáb"} \SpecialCharTok{\&}\NormalTok{ term }\SpecialCharTok{==} \StringTok{"fall"} \SpecialCharTok{\textasciitilde{}} \StringTok{"sáb\_fall"}\NormalTok{,}
\NormalTok{        wday }\SpecialCharTok{==} \StringTok{"sáb"} \SpecialCharTok{\&}\NormalTok{ term }\SpecialCharTok{==} \StringTok{"spring"} \SpecialCharTok{\textasciitilde{}} \StringTok{"sáb\_spring"}\NormalTok{,}
        \ConstantTok{TRUE} \SpecialCharTok{\textasciitilde{}} \FunctionTok{as.character}\NormalTok{(wday)}
\NormalTok{      )}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod3 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(n }\SpecialCharTok{\textasciitilde{}}\NormalTok{ wday2, daily)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{daily }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{gather\_residuals}\NormalTok{(}\AttributeTok{sab =}\NormalTok{ mod3, }\AttributeTok{all =}\NormalTok{ mod2) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(date, resid, }\AttributeTok{color =}\NormalTok{ model)) }\SpecialCharTok{+}
    \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{alpha =} \FloatTok{0.75}\NormalTok{) }\SpecialCharTok{+}
\NormalTok{    tema}
\end{Highlighting}
\end{Shaded}

\includegraphics{r4ds_files/figure-latex/unnamed-chunk-303-1.pdf}
...
\begin{Highlighting}[]
\NormalTok{daily }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{spread\_residuals}\NormalTok{(}\AttributeTok{sab =}\NormalTok{ mod3, }\AttributeTok{all =}\NormalTok{ mod2) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{diff =}\NormalTok{ sab }\SpecialCharTok{{-}}\NormalTok{ all) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(date, diff)) }\SpecialCharTok{+}
    \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{alpha =} \FloatTok{0.75}\NormalTok{) }\SpecialCharTok{+}
\NormalTok{    tema}
\end{Highlighting}
\end{Shaded}

\includegraphics{r4ds_files/figure-latex/unnamed-chunk-304-1.pdf}
...
\hypertarget{exr19-3-4}{%
\subsection*{Exercício 19.3.4}\label{exr19-3-4}}
\addcontentsline{toc}{subsection}{Exercício 19.3.4}

Crie uma nova variável \texttt{wday} que combine o dia da semana, período (para sábados) e feriados nacionais. COmo se parecem os resíduos desse modelo?

\begin{solution}
x
\end{solution}

\hypertarget{exr19-3-5}{%
\subsection*{Exercício 19.3.5}\label{exr19-3-5}}
\addcontentsline{toc}{subsection}{Exercício 19.3.5}

O que acontece se você encaixar um efeito dia da semana que varie por mês (por exemplo, \texttt{n\ \textasciitilde{}\ wday\ *\ month})? Por que isso não é útil?

\begin{solution}
x
\end{solution}

\hypertarget{exr19-3-6}{%
\subsection*{Exercício 19.3.6}\label{exr19-3-6}}
\addcontentsline{toc}{subsection}{Exercício 19.3.6}

Como você esperaria que o modelo \texttt{n\ \textasciitilde{}\ wday\ +\ ns(date,\ 5)} fosse? A partir de seus conhecimentos sobre dados, por que você esperaria que ele não fosse particularmente eficaz?

\begin{solution}
x
\end{solution}

\hypertarget{exr19-3-7}{%
\subsection*{Exercício 19.3.7}\label{exr19-3-7}}
\addcontentsline{toc}{subsection}{Exercício 19.3.7}
...
\hypertarget{exr19-3-8}{%
\subsection*{Exercício 19.3.8}\label{exr19-3-8}}
\addcontentsline{toc}{subsection}{Exercício 19.3.8}
...
\hypertarget{exr20-2-1}{%
\subsection*{Exercício 20.2.1}\label{exr20-2-1}}
\addcontentsline{toc}{subsection}{Exercício 20.2.1}

Uma tendência linear parece ser simples demais para a tendência geral. Você consegue fazer algo melhor com um polinômio quadrático? Como imterpreta os coeficientes do quadrático? (Dica: você pode querer transformar \texttt{year} para que tenha média zero)

\begin{solution}
Vamos utilizar a função \texttt{poly} para contruir um modelo colocando \texttt{lifeExp} em função de uma transformação de uma \texttt{year}.
Vamos utilizar a função \texttt{poly} para construir o modelo:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{country\_model }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(df) \{}
  \FunctionTok{lm}\NormalTok{(lifeExp }\SpecialCharTok{\textasciitilde{}} \FunctionTok{poly}\NormalTok{((year }\SpecialCharTok{{-}} \FunctionTok{mean}\NormalTok{(year)) }\SpecialCharTok{/} \FunctionTok{sd}\NormalTok{(year), }\DecValTok{2}\NormalTok{), }\AttributeTok{data =}\NormalTok{ df)}
\NormalTok{\}}

\NormalTok{(by\_country }\OtherTok{\textless{}{-}}\NormalTok{ gapminder }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(country, continent) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{nest}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{model =} \FunctionTok{map}\NormalTok{(data, country\_model)) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{resids =} \FunctionTok{map2}\NormalTok{(data, model, add\_residuals)))}
\end{Highlighting}
\end{Shaded}
...
##    <fct>    <fct>     <list>  
##  1 Afghani~ Asia      <tibble>
##  2 Albania  Europe    <tibble>
##  3 Algeria  Africa    <tibble>
##  4 Angola   Africa    <tibble>
##  5 Argenti~ Americas  <tibble>
##  6 Austral~ Oceania   <tibble>
##  7 Austria  Europe    <tibble>
##  8 Bahrain  Asia      <tibble>
##  9 Banglad~ Asia      <tibble>
## 10 Belgium  Europe    <tibble>
## # i 132 more rows
## # i 2 more variables:
## #   model <list>,
## #   resids <list>
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{unnest}\NormalTok{(by\_country, resids) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(year, resid)) }\SpecialCharTok{+}
    \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{group =}\NormalTok{ country), }\AttributeTok{alpha =}\NormalTok{ .}\DecValTok{5}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{geom\_smooth}\NormalTok{(}\AttributeTok{se =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-306-1.pdf}
...
\NormalTok{by\_country }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{unnest}\NormalTok{(glance, }\AttributeTok{.drop =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-307-1.pdf}
\end{solution}

\hypertarget{exr20-2-2}{%
\subsection*{Exercício 20.2.2}\label{exr20-2-2}}
\addcontentsline{toc}{subsection}{Exercício 20.2.2}

Explore outros métodos para visualizar a distribuição de \(R^2\) por continente. Você pode querer experimentar o pacote \textbf{ggbeeswarm}, que fornece métodos similares para evitar sobreposições como interferências, mas usa métodos deterministicos.
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-308-1.pdf}

\end{solution}

\hypertarget{exr20-2-3}{%
\subsection*{Exercício 20.2.3}\label{exr20-2-3}}
\addcontentsline{toc}{subsection}{Exercício 20.2.3}

Para criar o último gráfico (mostrando os dados para os países com os piores ajustes de modelo), precisamos de dois passos: criar um data frame com uma linha por país e, então, fazer um \emph{semijoin} com o conjunto de dados original. É possível evitar esse join se usarmos \texttt{unnest()}, em vez de \texttt{unnest(.drop\ =\ TRUE)}. Como?
...
\NormalTok{gapminder }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(country, continent) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{nest}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{model =} \FunctionTok{map}\NormalTok{(data, }\SpecialCharTok{\textasciitilde{}}\FunctionTok{lm}\NormalTok{(lifeExp }\SpecialCharTok{\textasciitilde{}}\NormalTok{ year, .))) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{glance =} \FunctionTok{map}\NormalTok{(model, broom}\SpecialCharTok{::}\NormalTok{glance)) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{unnest}\NormalTok{(glance) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{unnest}\NormalTok{(data) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(r.squared }\SpecialCharTok{\textless{}}\NormalTok{ .}\DecValTok{25}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(year, lifeExp, }\AttributeTok{color =}\NormalTok{ country)) }\SpecialCharTok{+}
    \FunctionTok{geom\_line}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{r4ds_files/figure-latex/unnamed-chunk-309-1.pdf}
...
\hypertarget{exr20-4-1}{%
\subsection*{Exercício 20.4.1}\label{exr20-4-1}}
\addcontentsline{toc}{subsection}{Exercício 20.4.1}
...
\hypertarget{exr20-4-2}{%
\subsection*{Exercício 20.4.2}\label{exr20-4-2}}
\addcontentsline{toc}{subsection}{Exercício 20.4.2}

Pense em funções úteis de resumo que, como \texttt{quantile()}, retornem valores múltiplos.

\begin{solution}
x
\end{solution}

\hypertarget{exr20-4-3}{%
\subsection*{Exercício 20.4.3}\label{exr20-4-3}}
\addcontentsline{toc}{subsection}{Exercício 20.4.3}

O que está faltando no data frame a seguir? Como \texttt{quantile()} retorna o pedaço que falta? Por que isso não é útil?

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mtcars }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(cyl) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{summarize}\NormalTok{(}\AttributeTok{q =} \FunctionTok{list}\NormalTok{(}\FunctionTok{quantile}\NormalTok{(mpg))) }\SpecialCharTok{\%\textgreater{}\%}
...
\hypertarget{exr20-4-4}{%
\subsection*{Exercício 20.4.4}\label{exr20-4-4}}
\addcontentsline{toc}{subsection}{Exercício 20.4.4}
...
\hypertarget{exr20-5-1}{%
\subsection*{Exercício 20.5.1}\label{exr20-5-1}}
\addcontentsline{toc}{subsection}{Exercício 20.5.1}

Por que a função \texttt{lenghts()} pode ser útil para criar colunas de vetores atômicos a partir de list-columns?

\begin{solution}
x
\end{solution}

\hypertarget{exr20-5-2}{%
\subsection*{Exercício 20.5.2}\label{exr20-5-2}}
\addcontentsline{toc}{subsection}{Exercício 20.5.2}
...
\hypertarget{exr22-2-1}{%
\subsection*{Exercício 22.2.1}\label{exr22-2-1}}
\addcontentsline{toc}{subsection}{Exercício 22.2.1}

Crie um gráfico sobre os dados de economia de combustível com rótulos \texttt{title}, \texttt{subtitle}, \texttt{caption}, \texttt{x}, \texttt{y} e \texttt{colour} customizados.
...
\NormalTok{mpg }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(displ, hwy)) }\SpecialCharTok{+}
    ...
    \FunctionTok{geom\_smooth}\NormalTok{(}\AttributeTok{se =} \ConstantTok{FALSE}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}
      \AttributeTok{title =} \StringTok{"Eficiência energética"}\NormalTok{,}
      \AttributeTok{subtitle =} \StringTok{"Consumo de combustível conforme cilindradas do motor e tipo de veículo"}\NormalTok{,}
      \AttributeTok{caption =} \StringTok{"Fonte: Fuel Economy {-} U.S. Department of Energy"}\NormalTok{,}
      \AttributeTok{x =} \StringTok{"Número de cilindros do motor"}\NormalTok{,}
      \AttributeTok{y =} \StringTok{"Consumo de combustível (mpg)"}\NormalTok{,}
      \AttributeTok{colour =} \StringTok{"Tipo de veículo"}
\NormalTok{    )}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-311-1.pdf}

\end{solution}

\hypertarget{exr22-2-2}{%
\subsection*{Exercício 22.2.2}\label{exr22-2-2}}
\addcontentsline{toc}{subsection}{Exercício 22.2.2}

A \texttt{geom\_smooth()} é, de certa forma, ilusória, porque \texttt{hwy} para motores grandes é inclinada para cima devido à inclusão de carros esporte leves com motores grandes. Use suas ferramentas de modelagem para ajustar e exibir um modelo melhor.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod1 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(hwy }\SpecialCharTok{\textasciitilde{}}\NormalTok{ displ, mpg)}
\NormalTok{mod1\_stats }\OtherTok{\textless{}{-}}\NormalTok{ broom}\SpecialCharTok{::}\FunctionTok{glance}\NormalTok{(mod1)}
\NormalTok{mod1\_data }\OtherTok{\textless{}{-}}\NormalTok{ mpg }\SpecialCharTok{\%\textgreater{}\%}
                \FunctionTok{add\_predictions}\NormalTok{(mod1) }\SpecialCharTok{\%\textgreater{}\%}
                \FunctionTok{add\_residuals}\NormalTok{(mod1)}

\NormalTok{mod1\_data }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(displ, hwy)) }\SpecialCharTok{+}
    \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{color =}\NormalTok{ class)) }\SpecialCharTok{+}
    \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ pred)) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}
      \AttributeTok{title =} \StringTok{"Modelo Linear"}
\NormalTok{    )}
\end{Highlighting}
\end{Shaded}

\includegraphics{r4ds_files/figure-latex/unnamed-chunk-312-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod1\_data }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(displ, resid)) }\SpecialCharTok{+}
    \FunctionTok{geom\_jitter}\NormalTok{() }\SpecialCharTok{+}
    \FunctionTok{geom\_ref\_line}\NormalTok{(}\AttributeTok{h =} \DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{r4ds_files/figure-latex/unnamed-chunk-313-1.pdf}
Como os resíduos do modelo apresentam uma variação ruim, vamos tentar utilizar uma função polinomial.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod2 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(hwy }\SpecialCharTok{\textasciitilde{}} \FunctionTok{poly}\NormalTok{(displ, }\DecValTok{2}\NormalTok{), mpg)}
\NormalTok{mod2\_stats }\OtherTok{\textless{}{-}}\NormalTok{ broom}\SpecialCharTok{::}\FunctionTok{glance}\NormalTok{(mod2)}
\NormalTok{mod2\_data }\OtherTok{\textless{}{-}}\NormalTok{ mpg }\SpecialCharTok{\%\textgreater{}\%}
                \FunctionTok{add\_predictions}\NormalTok{(mod2) }\SpecialCharTok{\%\textgreater{}\%}
                \FunctionTok{add\_residuals}\NormalTok{(mod2)}

\NormalTok{mod2\_data }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(displ, hwy)) }\SpecialCharTok{+}
    \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{color =}\NormalTok{ class)) }\SpecialCharTok{+}
    \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ pred)) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-314-1.pdf}
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-315-1.pdf}

Ainda temos parâmetros ruins, vamos aumentar o grau do polinômio.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod3 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(hwy }\SpecialCharTok{\textasciitilde{}} \FunctionTok{poly}\NormalTok{(displ, }\DecValTok{5}\NormalTok{), mpg)}
\NormalTok{mod3\_stats }\OtherTok{\textless{}{-}}\NormalTok{ broom}\SpecialCharTok{::}\FunctionTok{glance}\NormalTok{(mod3)}
\NormalTok{mod3\_data }\OtherTok{\textless{}{-}}\NormalTok{ mpg }\SpecialCharTok{\%\textgreater{}\%}
                \FunctionTok{add\_predictions}\NormalTok{(mod3) }\SpecialCharTok{\%\textgreater{}\%}
                \FunctionTok{add\_residuals}\NormalTok{(mod3)}

\NormalTok{mod3\_data }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(displ, hwy)) }\SpecialCharTok{+}
    \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{color =}\NormalTok{ class)) }\SpecialCharTok{+}
    \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ pred)) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-316-1.pdf}
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-317-1.pdf}

Parece que o problema não se resolverá pela simples mudança no grau do polinômio. Tentaremos então uma padronização da variável \texttt{displ}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{z }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(x, n) \{}
  \FunctionTok{poly}\NormalTok{((x }\SpecialCharTok{{-}} \FunctionTok{mean}\NormalTok{(x)) }\SpecialCharTok{/} \FunctionTok{sd}\NormalTok{(x), n)}
\NormalTok{\}}

\NormalTok{mod4 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(hwy }\SpecialCharTok{\textasciitilde{}} \FunctionTok{z}\NormalTok{(displ, }\DecValTok{5}\NormalTok{) }\SpecialCharTok{+}\NormalTok{ class, mpg)}
\NormalTok{mod4\_stats }\OtherTok{\textless{}{-}}\NormalTok{ broom}\SpecialCharTok{::}\FunctionTok{glance}\NormalTok{(mod4)}
\NormalTok{mod4\_data }\OtherTok{\textless{}{-}}\NormalTok{ mpg }\SpecialCharTok{\%\textgreater{}\%}
                \FunctionTok{add\_predictions}\NormalTok{(mod4) }\SpecialCharTok{\%\textgreater{}\%}
                \FunctionTok{add\_residuals}\NormalTok{(mod4)}

\NormalTok{mod4\_data }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(displ, hwy)) }\SpecialCharTok{+}
    \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
    \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ pred)) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-318-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod4\_data }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(displ, resid)) }\SpecialCharTok{+}
    \FunctionTok{geom\_jitter}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{color =}\NormalTok{ class)) }\SpecialCharTok{+}
    \FunctionTok{geom\_ref\_line}\NormalTok{(}\AttributeTok{h =} \DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{r4ds_files/figure-latex/unnamed-chunk-319-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod5 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(hwy }\SpecialCharTok{\textasciitilde{}} \FunctionTok{poly}\NormalTok{(displ, }\DecValTok{5}\NormalTok{) }\SpecialCharTok{*}\NormalTok{ class, mpg)}
\NormalTok{mod5\_stats }\OtherTok{\textless{}{-}}\NormalTok{ broom}\SpecialCharTok{::}\FunctionTok{glance}\NormalTok{(mod5)}
\NormalTok{mod5\_data }\OtherTok{\textless{}{-}}\NormalTok{ mpg }\SpecialCharTok{\%\textgreater{}\%}
                \FunctionTok{add\_predictions}\NormalTok{(mod5) }\SpecialCharTok{\%\textgreater{}\%}
                \FunctionTok{add\_residuals}\NormalTok{(mod5)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod5\_data }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(displ, hwy)) }\SpecialCharTok{+}
    \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{color =}\NormalTok{ class)) }\SpecialCharTok{+}
    \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ pred)) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-320-1.pdf}
...
\includegraphics{r4ds_files/figure-latex/unnamed-chunk-321-1.pdf}
\end{solution}

\hypertarget{exr22-2-3}{%
\subsection*{Exercício 22.2.3}\label{exr22-2-3}}
\addcontentsline{toc}{subsection}{Exercício 22.2.3}
...
\hypertarget{exr22-3-1}{%
\subsection*{Exercício 22.3.1}\label{exr22-3-1}}
\addcontentsline{toc}{subsection}{Exercício 22.3.1}
...
\hypertarget{exr22-3-2}{%
\subsection*{Exercício 22.3.2}\label{exr22-3-2}}
\addcontentsline{toc}{subsection}{Exercício 22.3.2}
...
\hypertarget{exr22-3-3}{%
\subsection*{Exercício 22.3.3}\label{exr22-3-3}}
\addcontentsline{toc}{subsection}{Exercício 22.3.3}
...
\hypertarget{exr22-3-4}{%
\subsection*{Exercício 22.3.4}\label{exr22-3-4}}
\addcontentsline{toc}{subsection}{Exercício 22.3.4}
...
\hypertarget{exr22-3-5}{%
\subsection*{Exercício 22.3.5}\label{exr22-3-5}}
\addcontentsline{toc}{subsection}{Exercício 22.3.5}
...
\hypertarget{exr22-4-1}{%
\subsection*{Exercício 22.4.1}\label{exr22-4-1}}
\addcontentsline{toc}{subsection}{Exercício 22.4.1}
...
\hypertarget{exr22-4-2}{%
\subsection*{Exercício 22.4.2}\label{exr22-4-2}}
\addcontentsline{toc}{subsection}{Exercício 22.4.2}
...
\hypertarget{exr22-4-3}{%
\subsection*{Exercício 22.4.3}\label{exr22-4-3}}
\addcontentsline{toc}{subsection}{Exercício 22.4.3}
...
\hypertarget{exr22-4-4}{%
\subsection*{Exercício 22.4.4}\label{exr22-4-4}}
\addcontentsline{toc}{subsection}{Exercício 22.4.4}
